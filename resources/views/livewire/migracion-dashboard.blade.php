<div class="p-6 space-y-8" wire:poll.3000ms>
    ...
    {{-- Instrucciones --}}
<div class="rounded-xl border border-blue-200 bg-blue-50 dark:bg-blue-900/20 dark:border-blue-800 p-4 space-y-2">
    <p class="text-sm font-medium text-blue-800 dark:text-blue-300">
        ¿Cómo migrar?
    </p>
    <ol class="text-xs text-blue-700 dark:text-blue-400 space-y-1 list-decimal list-inside">
        <li>Activá la VPN (necesario para Relevamientos Anuales)</li>
        <li>Hacé clic en <strong>Ejecutar</strong> en la migración que querés</li>
        <li>Corré <code class="bg-blue-100 dark:bg-blue-900 px-1 rounded font-mono">migrar.bat</code> en tu computadora</li>
        <li>Esperá que la ventana se cierre sola</li>
    </ol>
</div>
